...
#
# orders-service is started last: it's the saga orchestrator, so it needs
# users/catalog/inventory/payments already listening before it starts placing
# orders against them.
...
# Give NATS and the four producers/participants a moment before Orders starts
# building its read model and driving sagas against them.
