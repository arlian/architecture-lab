...
//!
//! This is the payoff of choreography: orders-command-service never had to
//! know this service exists, import anything from it, or be redeployed to
//! support it. Note it consumes the exact same events orders-query-service
//! does — they're just two different projections of the same log, one a
//! full read model, one a one-line log message.
