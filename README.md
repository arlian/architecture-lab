...
`bff/` branches off `microservices/` instead of continuing that chain: same
backend, but now two different client-facing gateways decide how much of it
each client actually sees.
