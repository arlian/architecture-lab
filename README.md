...
All five share the same little e-commerce domain (users, catalog, orders) on
...
a broker, by splitting reads from writes entirely, or by an explicit workflow
orchestrator coordinating a distributed transaction.
